...
export const Card = ({ title, image, description }: CardProps) => {
    return (
        <div className="flex flex-col justify-center items-center  relative">
           <div className="card w-52 h-40 cursor-pointer">
           <div className="w-full h-full overflow-hidden rounded-2xl">
                <img className="object-cover w-full h-full" src={image} alt={title} />
            </div>
            <div className="rounded-2xl card-body absolute top-0 w-52 h-40 flex justify-center items-center flex-col bg-blue-700/50">
